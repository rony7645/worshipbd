    ...
    <section className="section-padding fix">
        <div className="container">
            <div className="row">
                ...
                <h3 style={{ marginTop: "20px" }}>Interpretation and Definitions</h3>
                <h3 style={{ marginTop: "20px" }}>Interpretation</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Definitions</h3>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Worshipbd.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Worshipbd, accessible from <a href="https://worshipbd.com"
                                rel="external nofollow noopener" target="_blank">https://worshipbd.com</a></p>
                    </li>
                    <li>
                ...
                <h3 style={{ marginTop: "20px" }}>Acknowledgment</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Links to Other Websites</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Limitation of Liability</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Governing Law</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Disputes Resolution</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>For European Union (EU) Users</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>United States Legal Compliance</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Severability and Waiver</h3>
                <h3 style={{ marginTop: "20px" }}>Severability</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Waiver</h3>
                <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation
                    ...
                    subsequent breach.</p>
                <h3 style={{ marginTop: "20px" }}>Translation Interpretation</h3>
                <p>These Terms and Conditions may have been translated if We have made them available to You on our
                    Service.
                    You agree that the original English text shall prevail in the case of a dispute.</p>
                <h3 style={{ marginTop: "20px" }}>Changes to These Terms and Conditions</h3>
                ...
                <ul>
                    <li>
                        <p>By email: admin@worshipbd.com</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="https://worshipbd.com/contact"
                                rel="external nofollow noopener" target="_blank">https://worshipbd.com/contact</a></p>
                    </li>
                    <li>
                        <p>By phone number: +880 1784-388538</p>
                    </li>
                    <li>
                        <p>By mail: House: 32, Road: 04, Block: A, Rampura Banasree 1219 Dhaka, Bangladesh.</p>
                    </li>
                </ul>
            </div>
        </div>
