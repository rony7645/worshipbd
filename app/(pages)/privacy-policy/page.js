      ...
      <section className="section-padding fix">
        <div className="container">
            <div className="row">
                ...
                <h2 style={{ marginTop: "20px" }}>Interpretation and Definitions</h2>
                ...
                <h2 style={{ marginTop: "20px" }}>Collecting and Using Your Personal Data</h2>
                <h3 style={{ marginTop: "20px" }}>Types of Data Collected</h3>
                <h4>Personal Data</h4>
                ...
                <h3 style={{ marginTop: "20px" }}>Use of Your Personal Data</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Retention of Your Personal Data</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Transfer of Your Personal Data</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Delete Your Personal Data</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Disclosure of Your Personal Data</h3>
                ...
                <h3 style={{ marginTop: "20px" }}>Security of Your Personal Data</h3>
                ...
                <p>If We need to rely on consent as a legal basis for processing Your information and Your country
                    ...
                    information.</p>
                <h2 style={{ marginTop: "20px" }}>Links to Other Websites</h2>
